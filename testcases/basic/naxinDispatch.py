...
class NaxinDispatch(object):
    ...
    def testPatchChaxun(self):
        ...
        ul =self.login.driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[1]/div[2]/div/div[1]/form/div[1]/div/div/div').click()
        sleep(2)
        ...
        #选择日期
        self.login.driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[1]/div[2]/div/div[1]/form/div[4]/div/div/input').send_keys('2020-09-01')
        a = self.login.driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[1]/div[2]/div/div[1]/form/div[6]/div/div/input').send_keys('2020-09-03')
        sleep(1)
        self.login.driver.find_element_by_xpath('//*[@id="/dispatchmanage"]').click()
        sleep(1)
